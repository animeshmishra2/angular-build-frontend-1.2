...
@Component({
  selector: 'app-counter-orders',
  templateUrl: './counter-orders.component.html',
  styleUrls: ['./counter-orders.component.scss'],
})
export class CounterOrdersComponent implements OnInit {
